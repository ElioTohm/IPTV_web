...
class CatchUp implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $cmd = " -codec copy -ignore_unknown -map 0:v -map 0:a  -hls_time $hls_time -hls_list_size $hls_list_size -hls_flags delete_segments -hls_segment_filename $path/$stream->id/$stream->id_%03d.ts $path/$stream->id/master.m3u8";
